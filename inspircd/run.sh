...
<bind address="0.0.0.0" port="${LISTEN_PORT}" type="clients" />
<bind address="0.0.0.0" port="6697" type="clients" options="ssl" sslcertfile="${CONFIG_DIR}/server.pem" sslkeyfile="${CONFIG_DIR}/server.key" />
<class name="default">
